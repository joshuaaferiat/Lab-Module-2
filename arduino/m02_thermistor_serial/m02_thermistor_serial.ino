/*
  m02_thermistor_serial.ino
  Module 2 -- First Real Instrument Pieces
  Part 1 -- thermistor divider: averaged ADC -> voltage -> resistance -> temperature,
           printed as one labeled human-readable line.
  ...
  Baud:      9600
  Output:    one labeled line per report, e.g.
             time = 1.50 s  average ADC = 511.8  voltage = 2.501 V ...
...
const char* VERSION = "m02_thermistor_serial v1";
